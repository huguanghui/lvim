...
M.config = function()
  ...
  command_center.add({
    ...
    { description = "cmd history", cmd = "lua require('telescope.builtin').cmd_history()" },
    { description = "Show all available cmds", cmd = "Telescope cmds" },
    ...
    { description = "Show DAP cmds", cmd = "lua require'telescope'.extensions.dap.cmds{}" },
